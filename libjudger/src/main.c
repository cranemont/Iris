...
int main(int argc, char *argv[]) {
    ...
    // for stdbuf
    // _config.args[0] = "/usr/bin/stdbuf";
    // _config.args[1] = "-o0";
    // _config.args[2] = _config.exe_path;
    // int i = 3;
    // if (args->count > 0) {
    //     for (; i < args->count + 3; i++) {
    //         _config.args[i] = (char *)args->sval[i - 3];
    //     }
    // }
    // _config.args[i] = NULL;
    ...
    if (log_path->count > 0) {
        ...
        _config.log_path = "/log/judger.log";
    }
    ...
    // if(_result.signal == 31) {
    //     printf("\n*** UNAUTHORIZED SYSTEM CALL ***\n");
    // } else if (_result.result == 2) {
    //     printf("\n*** TIME LIMIT EXCEEDED ***\n");
    // } else if (_result.result == 3) {
